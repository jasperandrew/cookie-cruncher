...
function parseAndImportData(data) {
	...
	auras.forEach(aura => {
		switch (aura) {
			case '5':  IO.discounts['earth-shatterer'].el.checked = 1; break;
			case '7':  IO.discounts['fierce-hoarder'].el.checked = 1; break;
			case '18': IO.discounts['reality-bending'].el.checked = 1; break;
			default:
		}
	});
