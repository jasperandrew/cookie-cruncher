function load(data) {
    ...
    let inputs = document.querySelectorAll('.buildings input');
    inputs.forEach((input,i=0) => {
        input.value = buildings[i++].split(',')[0];
    });

    // Get upgrades
    let upgrades = { divine:285, season:160, santas:168, faberge:223, kit:288, kitchen:289 };
